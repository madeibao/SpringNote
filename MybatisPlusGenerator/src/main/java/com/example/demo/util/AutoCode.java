...
class AutoCode {
    public static void main(String[] args) {
        ...
        dataSourceConfig
                .setUrl("jdbc:mysql://127.0.0.1:3306/aspace3?userSSL=false&useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC")
